  ...
  <br><br>
    ...
    <div class="carros_recientes"> 
            ...
            <?php
                  ...
                  $consulta= ejecutarSQL::consultar("SELECT idCarro,Placas, Modelo, Asientos, Marca, Transmicion, Precio, Imagen FROM carros ORDER BY idCarro DESC");
                ...
                <div class="tarjeta">
                    ...
                    <?php
                      $car = $fila['idCarro'];
                    ?>
                    <div><a href="Rentar.php?variable=<?php echo $car; ?>">Rentar</a></div>
                </div>
                <?php
                      }
                      }
